	...
	public function mostrarTablaProductos(){
		...
		$orden = "id";
		  ...
		  for($i = 0; $i < count($productos); $i++){
			...
			/*===================================
			TIPO DE PRECIO (DÍA-NOCHE)
			=====================================*/
			  
			if ($productos[$i]["tipo_precio"] == 0)
			{
				$tipo_precio = "<button class='btn btn-info'>Día</button>";
			}else
			{
				$tipo_precio = "<button class='btn btn-primary'>Noche</button>";
			}
