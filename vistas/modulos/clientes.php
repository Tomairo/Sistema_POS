          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" id="editarCliente" name="editarCliente" required autocomplete="off">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" min="0" class="form-control input-lg" id="editarDNI" name="editarDNI" required autocomplete="off">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="email" class="form-control input-lg" id="editarEmail" name="editarEmail" required autocomplete="off">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" id="editarTelefono" name="editarTelefono" data-inputmask="'mask': '999-999-999'" data-mask required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" id="editarDireccion" name="editarDireccion" required autocomplete="off">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" id="editarFechaNacimiento" name="editarFechaNacimiento" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask required autocomplete="off">
