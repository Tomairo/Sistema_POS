          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevoCodigo" placeholder="Ingresar código" required autocomplete="off">
            ...
            <div class="form-group row">
              ...
              <div class="col-xs-6">
                ...
                <div class="input-group">
                  ...
                  <input type="number" class="form-control input-lg" name="nuevoPrecioCompra" min="0" placeholder="Precio de compra" required autocomplete="off">
              ...
              <div class="col-xs-6">
                ...
                <div class="input-group">
                  ...
                  <input type="number" class="form-control input-lg" name="nuevoPrecioVenta" min="0" placeholder="Precio de venta" required autocomplete="off">
