...
$(document).on("click",".btnEditarUsuario",function(){
    ...
    $.ajax({
        ...
        success: function(respuesta){
            ...
            /* Si no modifico ni el 'perfil', ni la 'foto', ni el 'password'
               dejo guardado el valor actual de dichos campos.*/
...
$("#nuevoUsuario").change(function(){
    ...
    $.ajax({
        ...
        success: function(respuesta){
            ...
            if(respuesta)
            {
                $("#nuevoUsuario").parent().after("<div class='alert alert-warning'>El usuario <b><i>"+usuario+"</i></b> ya está registrado en la base de datos</div>");
                $("#nuevoUsuario").val("");
            }
