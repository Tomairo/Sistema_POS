...
class ModeloProductos
{
    ...
    static public function mdlMostrarRankingProductos($tabla, $item, $valor, $cantidad_ventas){

		if($item != null){

			$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla WHERE $item = :$item ORDER BY $cantidad_ventas DESC");
			...
			$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla ORDER BY $cantidad_ventas DESC");
